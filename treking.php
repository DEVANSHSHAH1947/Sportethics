...
<head>
   ...
   <title>Category-Treking-Page</title>
...
<div class="hero">
<img src="images/trekking.jpg" class="bg"> 
      <nav>
   ...
   <div class = "products">
            <div class = "container">
                <h1 class = "lg-title">Special Trekking Products With Offers</h1>
                        ...
                        <div class = "product-col-r-bottom">
                            ...
                            <div class = "flex">
                                <div class = "product-col-content">
                                    ...
                                    <p class = "text-light">Lorem   Molestiae  quibusdam voluptatibus exercitationem autem voluptatum, beatae architecto odit, quisquam repellat. Deleniti, architecto ab.</p>
                                    <button type = "button" class = "btn-dark">Shop now</button>
                                </div>
                            </div>
                            <!-- right -->
                            <div class = "flex">
                                <div class = "product-col-content">
                                    ...
                                    <h2 class = "sm-title">Soccer Studds</h2>
                                    <p class = "text-light"> oluptatibus exercitationem autem voluptatum,exercitationem autem voluptatum, beatae architecto odit, quisquam repellat. Deleniti, architecto ab.</p>
                                    <button type = "button" class = "btn-dark">Shop now</button>
                                </div>
                            </div>
                        </div>
